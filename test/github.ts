...
import { createChangelogd, filterGithubReleasesForSemver, formatGithubReleases } from '../src'
...
describe('fetch github changelog', () => {
  ...
  //   const diff = await filterGithubReleasesForSemver('windicss/nuxt-windicss', 'v2.2.0', 'v2.2.5')
  //
